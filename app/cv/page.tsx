...
export default function CVPage() {
    return <>
        ...
        <PageBody>
            ...
            <PageParagraph>
                <AboutSection h2Content="Software Programmer Analyst" h3Content="University of Toronto Libraries">Develop, implement and troubleshoot software applications and integrations based on Java/Spring, PHP/CMS, HTML/CSS, Python, Linux DevOps and others. Interact with university patrons to identify and achieve technical goals with their research projects. Adapt to changing requirements quickly in a positive manner regarding both technical and non-technical aspects. Participate in team plans, including testing and deployment, for all new and legacy features.</AboutSection>
            </PageParagraph>
            <PageParagraph>
                <AboutSection h2Content="Project Mobile Software Engineer" h3Content="BlackSheep Inc.">Run a startup project with a small team to design and build mobile and web applications. Design and build frontend using Flutter, Material UI, ReactJS, NextJS, HTML5/CSS3, SASS. Build backend using Google Firebase, NoSQL, Git.</AboutSection>
            </PageParagraph>
            <PageParagraph>
